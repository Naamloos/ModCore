          ...
          <section className="text-center">
            <div className="flex flex-col items-center justify-center">
              <img
                ...
                onMouseEnter={(e) => {
                  (e.target as HTMLImageElement).style.animationPlayState =
                    "running";
                }}
                onMouseLeave={(e) => {
                  (e.target as HTMLImageElement).style.animationPlayState =
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card className="bg-gradient-to-br from-gray-800 to-gray-900 text-white shadow-lg rounded-lg hover:shadow-2xl transition-shadow">
                ...
                <CardContent>
                  ...
                  <p className="text-sm md:text-base text-gray-300">
                    ModCore helps you keep your server safe and clean with
              ...
              <Card className="bg-gradient-to-br from-gray-800 to-gray-900 text-white shadow-lg rounded-lg hover:shadow-2xl transition-shadow">
                ...
                <CardContent>
                  ...
                  />
                  <p className="text-sm md:text-base text-gray-300">
                    Keep track of great messages with a customizable starboard
                    feature.
                  </p>
                </CardContent>
              </Card>
