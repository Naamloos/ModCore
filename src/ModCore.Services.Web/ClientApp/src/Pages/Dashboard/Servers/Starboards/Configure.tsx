    ...
    <>
      <DashboardLayout>
        ...
        <Card className="w-full bg-gray-900 p-6 rounded-lg shadow-lg">
          <CardHeader>
            <CardTitle className="text-2xl">Starboard Configuration</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            <form>
              {(data.starboards as any)?.map(
                (starboard: ModCoreStarboard, index: number) => {
                  return (
                    <div
                      key={index}
                      ...
                      <div className="grid gap-4 mb-4">
                        <div>
                          ...
                          <p className="mt-2 text-sm text-gray-500">
                            ...
                            message to be added to the starboard.
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <DiscordEmojiPicker
                            onUpdate={(val) => {
                              const newStarboards = [
                                ...(data.starboards as ModCoreStarboard[]),
                              ];
