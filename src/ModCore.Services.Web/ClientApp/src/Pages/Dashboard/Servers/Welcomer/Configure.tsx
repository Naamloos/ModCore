      ...
      <DashboardLayout>
        ...
        {server && (
          <div className="pb-20">
            ...
            <div
              className="mt-6 md:flex md:space-x-6 relative"
            ...
            >
              ...
              <div className="w-full md:w-1/2 mb-6 md:mb-0">
                <Card className="w-full bg-gray-900 p-6 rounded-lg shadow-lg">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Configure the welcome message that is sent to new members
                  ...
                  <CardFooter>
                    <Button
                      className="w-full"
                      onClick={() =>
                        post(`/dashboard/servers/${server.id}/welcome`)
                      }
                      disabled={processing}
                    >
                ...
                <Card className="w-full bg-gray-900 p-6 rounded-lg shadow-lg mt-6">
                  <CardHeader>
                    <CardTitle className="text-2xl">Embeds</CardTitle>
                    <CardDescription>
                      Configure the embeds that are sent with the welcome
                      message.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      {data.message_payload.embeds?.map((embed, index) => (
                        <EmbedForm
                          key={index}
                          index={index}
                          embed={embed}
                          update={(newEmbed) => {
                            const newEmbeds = [...data.message_payload.embeds];
              ...
              <div className="w-full md:w-1/2 md:sticky md:top-10 self-start">
                ...
                <DiscordMessageVisualizerProxy
                  ...
                  embeds={data.message_payload.embeds ?? undefined}
