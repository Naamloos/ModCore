import {
  DiscordEmbed,
  DiscordEmbedField,
} from "@/Types/DiscordTypes/DiscordEmbed";
...
export default function EmbedForm({ embed, update, remove }: EmbedFormProps) {
  function addField() {
  ...
  return (
    <>
      <div className="relative mb-6 p-4 rounded-lg border-input border-[1px] shadow-md">
        ...
        <div className="mb-4">
          ...
          <Textarea
            ...
            onChange={(e) => update({ ...embed, description: e.target.value })}
        ...
        <div className="mb-4">
          <ColorPicker
            ...
            onUpdate={(value) => {
              const newEmbed = {
                ...embed,
                color: parseInt(value.slice(1).toUpperCase(), 16),
              };
              update(newEmbed);
            }}
          />
          ...
          <>
            ...
            <div className="mb-4">
              ...
              <Input
                ...
                onChange={(e) => {
                  const newEmbed: DiscordEmbed = { ...embed };
                  newEmbed.author = {
                    ...embed.author,
            ...
            <div className="mb-4">
              ...
              <Input
                ...
                onChange={(e) => {
                  const newEmbed = {
                    ...embed,
                    image: { ...embed.image, url: e.target.value },
                  };
                  update(newEmbed);
                }}
            ...
            <div className="mb-4">
              ...
              <Input
                ...
                onChange={(e) => {
                  const newEmbed = {
                    ...embed,
                    thumbnail: { ...embed.thumbnail, url: e.target.value },
                  };
                  update(newEmbed);
                }}
        ...
        <div className="mb-4">
          <h4 className="text-md font-semibold text-white mb-2">Fields</h4>
