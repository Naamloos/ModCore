...
export default function FakeDiscordMessage({
    ...
    return (
        <div
            className={`flex items-start mb-4 bg-[#2f3136] rounded-lg shadow-lg px-6 py-8 max-w-full sm:max-w-3xl ${
                className ?? ""
            }`}
        >
            <img
            ...
            <div className="ml-4 flex-1">
                ...
                {embed && (
                    <div
                        className={`mt-4 p-4 bg-[#36393f] rounded-lg border-l-[0.5rem] border-[#${color}] z-0 max-w-full sm:max-w-[650px]`}
                    >
                        {embed.author && (
