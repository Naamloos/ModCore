...
export default function FakeDiscordMessage({
    ...
    const renderContent = (text?: string) => {
        ...
        return parts.map((part, index) => {
            if (channelMentionRegex.test(part)) {
                return (
                    <span
                        key={index}
                        className="text-blue-500 hover:bg-opacity-30 bg-blue-500 bg-opacity-20 rounded-md px-1 inline-block"
                    >
                        #general
                    </span>
                );
            } else if (userMentionRegex.test(part)) {
                return (
                    <span
                        key={index}
                        className="text-blue-500 hover:bg-opacity-30 bg-blue-500 bg-opacity-20 rounded-md px-1 inline-block"
    ...
    return (
        ...
        >
            ...
            <div className="ml-4 flex-1">
                ...
                <p className="text-white mt-1">{renderContent(content)}</p>
                {/* fake Discord embeds */}
                {embeds &&
