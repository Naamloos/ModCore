...
/*
    ...
    TODO: replace this old code with a modernized version.
    This is taken directly from ModCore v2, and licensed under its MIT license.
    This code should not STAY in v3, but it should be modernized and improved upon. It is a placeholder for now.
...
namespace ModCore.Services.Consumer.Interactions.Remind
{
    ...
    /// </summary>
    internal class StringTokenizer : IEnumerable<string>, IEnumerator<string>
    {
