...
{
    [Group("list"), Description("Commands for managing your lists.")]
    public class Lists
    {
        private const string ListTut = @"
...
";
        ...
        public Lists(SharedData shared, DatabaseContextBuilder db, InteractivityExtension interactive)
        {
            this.Shared = shared;
            this.Database = db;
        ...
        [Command("list"), Description("Lists your... lists.")]
        ...
        [Command("set"), Description(ListTut)]
