...
namespace IronBlock.Blocks
{
	...
	{
        public static async Task<object> EvaluateAsync(this IEnumerable<Value> values, string name, Context context)
		{
		...
		public static async Task<object> EvaluateAsync(this Workspace workspace, IDependency dependency)
		{
			return await workspace.EvaluateAsync(new Context(dependency));
		}

		public static SyntaxNode Generate(this Workspace workspace, IDependency dependency)
		{
			var context = new Context(dependency);
